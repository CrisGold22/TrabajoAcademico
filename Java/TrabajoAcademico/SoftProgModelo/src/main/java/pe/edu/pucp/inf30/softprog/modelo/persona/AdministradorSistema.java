...
public class AdministradorSistema extends Persona {
    ...
    public AdministradorSistema(Cargo cargo, double sueldo, Jerarquia jerarquia, CuentaUsuario cuenta, String dni, String nombre, String apellidoPaterno, String apellidoMaterno, Genero genero, LocalDateTime fechaNacimiento, int telefono) {
    ...
    public AdministradorSistema(Cargo cargo, double sueldo, Jerarquia jerarquia, CuentaUsuario cuenta, String dni, String nombre, String apellidoPaterno, String apellidoMaterno, Genero genero, LocalDateTime fechaNacimiento, int telefono, int id, boolean activo) {
