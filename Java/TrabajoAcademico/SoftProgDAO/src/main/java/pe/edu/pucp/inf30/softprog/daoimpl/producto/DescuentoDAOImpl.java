...
public class DescuentoDAOImpl extends BaseDAO<Descuento> implements DescuentoDAO{
    ...
    @Override
    public boolean actualizarDescuentoPorIdProducto(Integer id, Descuento modelo) {
        
        return ejecutarComando(conn -> {
            try (PreparedStatement cmd = this.comandoActualizarDescuentoPorIdProducto(conn,id, modelo)) {
