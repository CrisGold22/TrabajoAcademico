...
public class SoftProgPruebas {
	...
	CategoriaProducto categoria = new CategoriaProducto();
        ...
        // PRUEBAS HECHAS EL 9/11/2025 POR JESUS
        
    // VERIFICAMOS QUE HAYA STOCK SUFICIENTE PARA EL PRODUCTO ELEGIDO POR ID
        
        
        ProductoBO productoBo2 = new ProductoBOImpl();
        
        boolean prueba1 = productoBo2.verificarStockSuficientePorID(producto.getId(),5);
        
        ProductoBO productoBo3 = new ProductoBOImpl();
        
        boolean prueba2 = productoBo3.verificarStockSuficientePorID(producto.getId(), 100);
        
        ProductoBO productoBo4 = new ProductoBOImpl();
        
    // VERIFICAMOS QUE HAYA STOCK SUFICIENTE PARA EL PRODUCTO ELEGIDO POR SKU
    
        boolean prueba3 = productoBo4.verificarStockSuficientePorSKU(producto.getSKU(),5);
        
        ProductoBO productoBo5 = new ProductoBOImpl();
        
        boolean prueba4 = productoBo5.verificarStockSuficientePorSKU(producto.getSKU(), 100);
        
    // ACTUALIZAMOS EL PRECIO DESCUENTO DEL PRODUCTO
    //  PARAMETROS  ID_PRODUCTO     NUEVO_PRECIO_DESCUENTO
        
        DescuentoBO prueba = new DescuentoBOImpl();
        
        prueba.actualizarPrecioDescuentoProducto(producto.getId(), 3000);
