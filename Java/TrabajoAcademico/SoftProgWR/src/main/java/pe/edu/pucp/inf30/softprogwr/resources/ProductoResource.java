...
public class ProductoResource {
    ...
    public Response crear(Producto producto) {
        if (producto == null
                ...
                || producto.getSku() == null || producto.getSku().isBlank()) {
...
//    Si funciona
    ...
    @GET
    @Path("listaProductosPorCategoria/{nombreCategoria}")
    public List<Producto> listaProductosPorCategoria(@PathParam("nombreCategoria") String nombre) {
        return productoBO.listaProductosPorCategoria(nombre);
    }
}
