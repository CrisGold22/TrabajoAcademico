...
//        pruebaConEmpresa();          <-- prueba obsoleta 
//        pruebaListar();
...
//        pruebaLineaCarrito();
    ...
    public static void hashearPasswords(){
        ...
        List<CuentaUsuario> listaCuentas = new CuentaUsuarioBOImpl().listar();
        
        for(CuentaUsuario c : listaCuentas){
            System.out.println(c.getId() + "   " + c.getCorreo() + "   " + PasswordUtils.hashPassword(c.getPassword()));
        }
        
        
    }
    
    public static void pruebaLineaCarrito(){
        
//        LineaCarrito linea = new LineaCarrito();
//        
//        linea.setActivo(true);
//        linea.setCantidad(12);
//        linea.setCarritoCompras(new CarritoComprasBOImpl().obtener(1));
//        linea.setPrecio(123);
//        linea.setProducto(new ProductoBOImpl().obtener(1));
//        linea.setSubTotal(12 * 123);
//        new LineaCarritoBOImpl().insertar(linea);
        ...
        for(LineaCarrito linea : carrito.getLineasCarrito()){
            System.out.println(linea.getId() + "  " + linea.getProducto().getId() + "  " + linea.getPrecio());
        }
    ...
    public static void pruebaObtenerProductosPorCategoria(){
        ...
        listaProductos = productoBO.obtenerProductosPorCategoria(14);
    ...
    public static void pruebaObtenerMarcasPorCategoria(){
        ...
        listaMarcas = categoriaBO.obtenerMarcasPorCategoria(14);
    ...
    public static void pruebaFiltroPorPrecio(){
        ...
        prueba1 = productoBO.filtrarProductoPorPrecioRegular(8,1,20);
       ...
       prueba1 = productoBO.filtrarProductoPorPrecioAlMayor(8, 1, 20);
...
//        carrito.setEstado(EstadoCarrito.COMPLETADO);
        ...
        for (CarritoCompras c : listaCarrito) {
            System.out.println(c.getId() + "   " + c.getSubtotal()+ "   " + c.getMontoFinal());
        }
        ...
        LocalDateTime fechaSQLOrden = LocalDateTime.now();
        ...
        LocalDateTime fechaSQL = LocalDateTime.now();
        ...
        producto.setPrecioAlMayor(3500);
        producto.setPrecioRegular(4000);
        producto.setImagenURL("www.google.com.pe");
        producto.setMedidaAlMayor(UnidadMedida.BOTELLA);
        producto.setStockDisponible(10);
        producto.setStockMaximo(50);
        producto.setActivo(true);
