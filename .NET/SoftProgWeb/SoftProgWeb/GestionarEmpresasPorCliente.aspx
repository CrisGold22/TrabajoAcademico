...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container-fluid">
        <div class="row mb-3">
            <div class="col-md-10">
                <h2>Cliente:
                    <asp:Literal ID="litNombreCliente" runat="server"></asp:Literal></h2>
                <h4>Usuario:
                    <asp:Literal ID="LitUsuario" runat="server"></asp:Literal></h4>
                <%--<h4>    Email: <asp:Literal ID="litEmail" runat="server"></asp:Literal></h4>--%>
                <h5>Genero:
                    <asp:Literal ID="litGenero" runat="server"></asp:Literal></h5>
                <h5>Telefono:
                    <asp:Literal ID="litTelefono" runat="server"></asp:Literal></h5>
                <h5>Categoria:
                    <asp:Literal ID="litCatCli" runat="server"></asp:Literal></h5>
                <h5>Linea de Credito:
                    <asp:Literal ID="LitCredito" runat="server"></asp:Literal></h5>
                <h5>Nro Pedidos Historicos:
                    <asp:Literal ID="LitPedidosHist" runat="server"></asp:Literal></h5>
                <h5>Nro Pedidos Mensuales Prom.:
                    <asp:Literal ID="LitPedidosMen" runat="server"></asp:Literal></h5>
