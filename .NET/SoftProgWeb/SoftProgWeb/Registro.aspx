    ...
    <div class="registration-card">
        ...
        <div class="form-step active" id="step1">
            ...
            <div class="form-group-custom">
                <label class="form-label-custom">Número de DNI de Representante Legal</label>
            ...
            <div class="form-group-custom">
                ...
                <asp:TextBox ID="txtUsuario" runat="server" CssClass="form-control-registro" 
        ...
        <div class="form-step" id="step2">
            ...
            <div class="form-group-custom">
                <label class="form-label-custom">Usuario</label>
                <input type="text" class="form-control-registro filled" id="displayUsuario" readonly />
            </div>
        ...
        <div class="form-step" id="step3">
            <div class="form-group-custom">
                ...
                <asp:TextBox ID="txtNombre" runat="server" CssClass="form-control-registro" 
                    placeholder="Escribe tu primer nombre ..."></asp:TextBox>
            </div>
            ...
            <div class="form-group-custom">
                ...
                <asp:TextBox ID="txtApellidoPaterno" runat="server" CssClass="form-control-registro" 
                    placeholder="Escribe tu primer apellido ..."></asp:TextBox>
            </div>
            ...
            <div class="form-group-custom">
                ...
                <asp:TextBox ID="txtApellidoMaterno" runat="server" CssClass="form-control-registro" 
                    placeholder="Escribe tu segundo apellido ..."></asp:TextBox>
            </div>
            ...
            <div class="form-group-custom">
                ...
                <asp:TextBox ID="txtDireccion" runat="server" CssClass="form-control-registro" 
                    placeholder="Ejemplo: Mz L 20 Av argentina"></asp:TextBox>
            </div>

            <div class="form-group-custom">
                <label class="form-label-custom">Fecha de Nacimiento</label>
                <asp:TextBox ID="txtFechaNacimiento" runat="server" CssClass="form-control-registro"
                    placeholder="AAAA-MM-DD" TextMode="Date"></asp:TextBox>
            </div>
            ...
            <div class="form-actions">
                ...
                <asp:Button ID="btnRegistrar" runat="server" CssClass="btn-step btn-registrar" 
                    Text="Registrarse" OnClientClick="return validateStep3();" OnClick="btnRegistrar_Click" />
            </div>
        </div>
    </div>
    ...
    <div class="success-modal" id="successModal">
     ...
     <script>
         ...
         function validateStep1() {
             ...
             const usuario = document.getElementById('<%= txtUsuario.ClientID %>').value.trim();
             ...
             if (!usuario || !numDoc || !correo || !telefono || !password) {
        ...
        function nextStep(step) {
            if (step === 1) {
                ...
                document.getElementById('displayUsuario').value = document.getElementById('<%= txtUsuario.ClientID %>').value;
