...
CALL insertarProducto('Arroz Extra COSTEÑO Bolsa 750g', 'SKU007', 'Arroz COSTEÑO 750g, perfecto para recetas rápidas', 'costeno750g.png', 5.15, 4.90, 'GRAMO', 100, 150, 1, 1, 'COSTEÑO', @nuevo_id);
...
CALL insertarProducto('Filete de Atún CAMPOMAR en Aceite Vegetal Lata 150g Paquete 6un', 'SKU011', 'Filete de Atún CAMPOMAR, sabor y calidad en cada lata', 'fileteAtunCampomar150gx6.png', 32.45, 30.90, 'GRAMO', 100, 150, 1, 2, 'CAMPOMAR', @nuevo_id);
CALL insertarProducto('Trozos de Atún en Aceite Vegetal y Sal GLORIA Lata 140g Paquete 6un', 'SKU012', 'Trozos de Atún GLORIA, ideal para ensaladas y salsas', 'trozosAtunGloria140gx6.png', 29.93, 28.50, 'GRAMO', 100, 150, 1, 2, 'GLORIA', @nuevo_id);
CALL insertarProducto('Filete de Atún FLORIDA en Aceite Vegetal Lata 140g Paquete 6un', 'SKU013', 'Atún FLORIDA, el filete perfecto para tus comidas', 'fileteAtunFlorida140gx6.png', 31.50, 30.00, 'GRAMO', 100, 150, 1, 2, 'FLORIDA', @nuevo_id);
CALL insertarProducto('Grated de Atún en Aceite Vegetal MARINERO Lata 140g Paquete 6un', 'SKU014', 'Atún MARINERO, gratinado en aceite vegetal de alta calidad', 'gratedAtunMarinero140gx6.png', 23.63, 22.50, 'GRAMO', 100, 150, 1, 2, 'MARINERO', @nuevo_id);
CALL insertarProducto('Conservas Cocktail de Frutas ARO 820g', 'SKU015', 'Cóctel de frutas ARO, delicioso y refrescante', 'conservasFrutas820g.png', 11.34, 10.80, 'GRAMO', 100, 150, 1, 2, 'ARO', @nuevo_id);
CALL insertarProducto('Conserva de Lenteja Tocino ARO Lata 425g', 'SKU016', 'Lenteja Tocino ARO, perfecta para guisos y sopas', 'conservaLentejaAro425g.png', 7.25, 6.90, 'GRAMO', 100, 150, 1, 2, 'ARO', @nuevo_id);
CALL insertarProducto('Trozos de Atún BELTRAN en Aceite Vegetal Lata 170g Paquete 6un', 'SKU017', 'Trozos de Atún BELTRAN, un toque de mar en cada plato', 'trozosAtunBeltran170g.png', 34.34, 32.70, 'GRAMO', 100, 150, 1, 2, 'BELTRAN', @nuevo_id);
CALL insertarProducto('Filete de Atún en Aceite Vegetal A1 Lata 140g Paquete 6un', 'SKU018', 'Atún A1 en aceite, sabor y frescura para tu mesa', 'fileteAtunA1x6.png', 30.76, 29.30, 'GRAMO', 100, 150, 1, 2, 'A1', @nuevo_id);
...
CALL insertarProducto('Agua de Mesa CIELO Sin gas Paquete 15 Botellas 625ml c/u', 'SKU019', 'Agua CIELO, pureza y frescura en cada sorbo', 'aguacielo625x15.png', 11.50, 10.95, 'MINILITRO', 100, 150, 1, 4, 'CIELO', @nuevo_id);
...
CALL insertarProducto('Chifles CRICKET\S Sabor a Leche de Tigre Bolsa 500g', 'SKU024', 'Chifles CRICKET\S, sabor auténtico a leche de tigre', 'chilesCRICKETS500g.png', 23.00, 21.90, 'GRAMO', 100, 150, 1, 5, 'CRICKET\S', @nuevo_id);
CALL insertarProducto('Papas con Sal de Mar INKA CHIPS Bolsa 33g Tira 6un', 'SKU025', 'Papas INKA CHIPS, sabor natural en cada bocado', 'papasinkachipsx6_33g.png', 12.66, 12.10, 'GRAMO', 100, 150, 1, 5, 'INKA CHIPS', @nuevo_id);
CALL insertarProducto('Chizitos CHEETOS Sabor a Queso Tira 12 Bolsas 18g c/u', 'SKU026', 'Chizitos CHEETOS, crujientes y deliciosos, sabor a queso', 'chizitos18gx12.png', 4.28, 4.08, 'GRAMO', 100, 150, 1, 5, 'CHEETOS', @nuevo_id);
CALL insertarProducto('Piqueo LOS CUATES Tradicional Tira 12 Bolsas 43g c/u', 'SKU027', 'Piqueo LOS CUATES, el snack ideal para compartir', 'piqueo43gx12.png', 10.58, 10.08, 'GRAMO', 100, 150, 1, 5, 'LOS CUATES', @nuevo_id);
CALL insertarProducto('Palitos de Maíz CHEESE TRIS Tira 12 Bolsas 28g c/u', 'SKU028', 'Palitos de Maíz CHEESE TRIS, el toque crujiente de siempre', 'cheesetris28gx12.png', 10.58, 10.08, 'GRAMO', 100, 150, 1, 5, 'CHEESE TRIS', @nuevo_id);
CALL insertarProducto('Snacks CHEETOS Mega Queso Tira 12 Bolsas 21g c/u', 'SKU029', 'Snacks CHEETOS, mega sabor a queso en cada bolsa', 'cheetosx12.png', 10.58, 10.08, 'GRAMO', 100, 150, 1, 5, 'CHEETOS', @nuevo_id);
CALL insertarProducto('Chifles Salados BUCKY Bolsa 26g x 12un', 'SKU030', 'Chifles BUCKY, crujientes y salados, el snack perfecto', 'chilesbuckyx12.png', 12.50, 11.90, 'GRAMO', 100, 150, 1, 5, 'BUCKY', @nuevo_id);
CALL insertarProducto('Papas LAY\S Clásicas Tira 12 Bolsas 17g c/u', 'SKU031', 'Papas LAY\S, sabor clásico y delicioso en cada bolsa', 'papasLaysx12_17g.png', 10.21, 9.72, 'GRAMO', 100, 150, 1, 5, 'LAY\S', @nuevo_id);
CALL insertarProducto('Chifles Salado KARINTO Tira 13 Bolsas 34g c/u', 'SKU032', 'Chifles KARINTO, sabor salado en cada bocado crujiente', 'chifleskarinto34gx13.png', 21.16, 20.15, 'GRAMO', 100, 150, 1, 5, 'KARINTO', @nuevo_id);
CALL insertarProducto('Jabón de Tocador Frutos Rojos ARO Sixpack 750g', 'SKU033', 'Jabón ARO Frutos Rojos, suavidad y frescura en cada baño', 'jabonArox6.png', 16.70, 15.90, 'GRAMO', 100, 150, 1, 6, 'ARO', @nuevo_id);
CALL insertarProducto('Jabón Antibacterial PROTEX Avena Paquete 6 Bolsas 110g c/u', 'SKU034', 'Jabón PROTEX, protección y suavidad para tu piel', 'jabonprotex110gx6.png', 21.29, 20.28, 'GRAMO', 100, 150, 1, 6, 'PROTEX', @nuevo_id);
CALL insertarProducto('Jabón en Barra Antibacterial NEKO Extra Protección Paquete 6un', 'SKU035', 'Jabón NEKO, extra protección para tu piel', 'jabonNekox6.png', 18.27, 17.40, 'GRAMO', 100, 150, 1, 6, 'NEKO', @nuevo_id);
CALL insertarProducto('Jabón de Tocador PALMOLIVE Exfoliación Diaria Avena y Azúcar Morena Paquete 6 Bolsas 75g c/u', 'SKU036', 'Jabón PALMOLIVE, exfoliación suave con avena y azúcar morena', 'jabon palmolivex6.png', 17.64, 16.80, 'GRAMO', 100, 150, 1, 6, 'PALMOLIVE', @nuevo_id);
